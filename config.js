...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "WApDiSaB#ZnioBmMZS49hrhKylxWDKDRpm4E8_85_DnrTrREr--M",
    CAPTION: process.env.CAPTION || "POWERED BY dinuwh SILENTLOVER432",
    ...
    BOT_NAME: process.env.BOT_NAME || "dinu-panthermd",
